    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter)
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/question-categories/{categoryId}").permitAll() // API
                                                                                                          // Questions
                                                                                                          // (Public
                                                                                                          // endpoints)
                        ...
                        .requestMatchers(HttpMethod.GET, "/sti-services/tests/{testId}/results").authenticated() // API
                                                                                                                 // Menstrual
                                                                                                                 // Cycle
                                                                                                                 // (Authenticated
                                                                                                                 // user
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/questions/{questionId}").hasRole("STAFF") // API STI
                                                                                                        // Services
                                                                                                        // (Staff
                                                                                                        // actions)
                        ...
                        .requestMatchers(HttpMethod.PUT, "/admin/users/{userId}").hasRole("ADMIN") // API App Config
                                                                                                   // Management (Admin
                                                                                                   // only)

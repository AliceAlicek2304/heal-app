...
class STIPackageServiceTest {
    ...
    void createPackage_Success_Staff() {
        ...
        // Act
        ApiResponse<STIPackageResponse> response = stiPackageService.createPackage(validRequest, staffUser.getId());
    ...
    void packageResponse_PriceCalculations() {
        ...
        assertEquals(BigDecimal.valueOf(800000), packageResponse.getTotalIndividualPrice()); // 500k + 300k
        assertEquals(BigDecimal.valueOf(100000), packageResponse.getSavingsAmount()); // 800k - 700k
